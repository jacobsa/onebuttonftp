...
// below, are copyright Aaron Jacobs.
 
// Modified by Aaron Jacobs:
//	2005-07-17 - Added performSelector method that takes three arguments.
//	2005-08-07 - Removed unused notification stuff and fixed bug (?) where
//					receiver and arguments were not released on a failed send
//					of a port message.
