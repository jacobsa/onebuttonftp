...
// If the current thread is the main thread, send the given message to the
// socket thread.  Otherwise send the message to the main thread.  Only wait for
// so long, and if we block for too long waiting to send the message then retry
// later.
